...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        left = right = bottom = top = resources.getDimensionPixelSize(R.dimen.ms_padding_min);
        if (rtl) {
            right = resources.getDimensionPixelSize(R.dimen.ms_padding);
        } else {
            left = resources.getDimensionPixelSize(R.dimen.ms_padding);
        }
